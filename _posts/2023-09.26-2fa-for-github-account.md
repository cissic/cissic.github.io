...
1.  [2fa for github accout](#orgb15467a)
    1.  [How to set two factor authentication for github accout with the use of KeePassXC](#org75c9316)
        1.  [Getting Github account's secret](#orge93871d)
        2.  [Configuring KeepassXC entry linked to Github's account](#org360fb59)
