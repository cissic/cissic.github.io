...
1.  [Obtaining latex output from Matlab blocks - the easiest way (at least for me)](#org0a6d94e)
    1.  [Source code blocks](#org1116227)
    2.  [Inline source blocks](#orgaaff579)
    3.  [Making matlab code blocks be easily converted to octave code blocks](#org67bf1ec)
        1.  [Matlab](#org159b33d)
        2.  [Octave](#orga52f7b1)
    4.  [Summary](#org5dcce9f)
