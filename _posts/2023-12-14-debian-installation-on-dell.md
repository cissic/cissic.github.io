...
1.  [Debian on Dell](#orge1f9e1b)
    1.  [Preparation](#org904fb06)
        1.  [Debian live default login/password](#org1af1349)
        2.  [Warnings](#org6b1d30b)
        3.  [Disk partitioning](#org80fd7ad)
    2.  [Installation](#org5e4e5e0)
        1.  [General notes](#orgc52539a)
        2.  [System configuration](#org169891f)
    3.  [Configuration](#org13da05a)
        1.  [Battery drainage/Moderm Standby/Power management - sleep modes/hibernation](#org4ed6efa)
        2.  [Okular and buttons](#org0a5815b)
        3.  [Dell Thunderbolt Dock WD22TB4](#org9d05a4b)
        4.  [Lenovo keyboard](#org59ac515)
        5.  [Controlling Intel Turbo Boost in Linux](#org13ffb0b)
        6.  [ZRAM - tool for optimizing RAM usage](#orgb4d5584)
        7.  [Do I need SWAP?](#org5ba3de7)
        8.  [Updating/upgrading with cron](#org81a2d59)
        9.  [Useful links:](#org01d0303)
...
4.  Installing firmware, software and other ware
    ...
    2.  Disabling system notification sounds
    ...
    7.  SOLVED Problem with conky disappearing
    ...
    8.  Matlab
        ...
        2.  PROBLEM 2
            ...
            <file:///home/mb/org/2024.03.01-dell-precision-3581---graphic-drivers.md>
...
Automatic updates are not recommended for testing. From [here](https://www.debian.org/doc/manuals/debian-faq/uptodate.en.html):
